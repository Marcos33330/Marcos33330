...
Before coding I spent 5+ years in professional kitchens (bakery, catering and restaurants). That background gave me discipline, teamwork and calm under pressure - now I apply them to building web applications.

## Stack

`JavaScript` `React` `HTML5` `CSS3` `Python` `Flask` `SQL` `Git & GitHub` `REST APIs` `Responsive Design`
